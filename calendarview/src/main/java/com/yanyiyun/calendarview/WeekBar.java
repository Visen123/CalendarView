/*
 * Copyright (C) 2016 huangyanyiyun_dev <huangyanyiyun_dev@163.com>
 ...
 */
package com.yanyiyun.calendarview;
 ...
 * Created by huangyanyiyun on 2017/11/30.
 */
public class WeekBar extends LinearLayout {
    ...
    public WeekBar(Context context) {
        super(context);
        if ("com.yanyiyun.calendarview.WeekBar".equals(getClass().getName())) {
    ...
    void setup(CalendarViewDelegate delegate) {
        ...
        if ("com.yanyiyun.calendarview.WeekBar".equalsIgnoreCase(getClass().getName())) {
